                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="stock" id="stock" class="form-control" value="{{ old('stock', 0) }}" min="0">
                            @error('stock')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="harga" id="harga" class="form-control" value="{{ old('harga') }}" min="0" step="0.01">
                            @error('harga')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="date" name="tanggal_expired" id="tanggal_expired" class="form-control" value="{{ old('tanggal_expired') }}">
