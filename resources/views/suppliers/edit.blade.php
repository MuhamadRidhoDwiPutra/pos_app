        ...
        <div class="card-body">
            <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="no_supplier" id="no_supplier" class="form-control" value="{{ old('no_supplier', $supplier->no_supplier) }}">
                    @error('no_supplier')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_pic" id="nama_pic" class="form-control" value="{{ old('nama_pic', $supplier->nama_pic) }}">
                    @error('nama_pic')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
                </div>
